...
> A web application to help you find your next hotel.
...
Here are some of the current features that Zero Hustle has:

- [x] User authentication with Google & Next Auth
- [x] User authorization
- [x] Route protection
- [x] User profile with user listings
- [x] Hotel Listing CRUD
- [x] Hotel image upload (Multiple)
- [x] Hotel search
- [x] Book | Reserve Hotels
- [x] Make payments for Bookings via Mpesa
- [x] Internal messages with 'unread' notifications
- [x] Photoswipe image gallery
- [x] Mapbox maps
- [x] Toast notifications
- [x] Hotel bookmarking / saved hotels
- [x] Hotel sharing to social media
- [x] Loading spinners
- [x] Responsive design (Tailwind)
- [x] Custom 404 page

Hotel Pulse uses the following technologies:
